...
to develop a mesh network using Digimesh protocol. The hardware will include an
XBee RF module connected with XBee Grove development board for communicating
with a computer and use XCTU software to send and receive packets. I will be
...
The problems solved by these projects are creating a mesh network using Digimesh
protocol to extend the connectivity range using three different RF modules where
one module will relay data between the other two RF modules.
...
devices to be able to relay information from node to node.

 

I have searched for prior art via Humber’s IEEE subscription selecting “My
Subscribed Content” [@6169161] and have found and read [@7352296] which provides
...
-   Web access of databases from CENG 256 Internet Scripting
...
| **Phase 1**                                                                               |                |                                                                                                                                |
| RF module with development board x 3                                                      | \>\$143.55     | Covered by Humber Prototype Lab.                                                                                               |
| **Phase 1 Total**                                                                         | **\>\$143.55** |                                                                                                                                |
| **Phase 2**                                                                               |                |                                                                                                                                |
...
mesh network of RF modules. This is an opportunity to integrate the knowledge
and skills developed in our program to create a collaborative IoT capstone
project demonstrating my ability to learn how to support projects such as the
initiative described by [@7352296]. I request approval of this project.
